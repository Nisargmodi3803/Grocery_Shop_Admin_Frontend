    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(
                `http://localhost:9000/add-coupon-code`, {
                code: code,
                title: title,
                startDate: startDate,
                endDate: endDate,
            ...
            if (response.status === 200) {
                await Swal.fire({
                    icon: 'success',
                    title: 'Added!',
                    text: 'Coupon Code has been added successfully.',
                    timer: 2000,
            ...
            console.error(error);
            alert('Something went wrong while Adding the Coupon Code.');
        }
    };
                ...
                <form onSubmit={handleSubmit} encType="multipart/form-data">
                    <div className="form-section">
                        ...
                        <div className="button-group">
                            <button type="submit" className="update-btn" disabled={isCodeExist}>Add</button>
