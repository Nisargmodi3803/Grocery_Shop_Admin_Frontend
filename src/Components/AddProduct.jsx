...
export const AddProduct = () => {
    ...
    const handleNameChange = async (e) => {
        ...
        try {
            const response = await axios.get(`http://localhost:9000/check-product-slug-title?slugTitle=${slugTitle}`)
    ...
    const handleSlugTitleChange = async (e) => {
        ...
        try {
            const response = await axios.get(`http://localhost:9000/check-product-slug-title?slugTitle=${e.target.value}`)
    ...
    const calculateBasePriceFromMRP = (mrp, cgst, sgst) => {
        if (!mrp || !cgst || !sgst) return "";
        const basePrice = mrp / (1 + (parseFloat(cgst) + parseFloat(sgst)) / 100);
                    ...
                    <div className="form-section">
                        ...
                        <div className="custom-dropdown">
                            ...
                            >
                                ...
                                <span className="arrow">{openDropdown === 'brand' ? '▲' : '▼'}</span>
                            </div>
                            {openDropdown === 'brand' && (
